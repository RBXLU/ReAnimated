...
Client‑side only — not required on servers. **NOT** Compatible with **Sodium** and other
...
- Контейнеры (печь, сундук, инвентарь и др.) плавно выезжают снизу.
...
**Поддержка:** Minecraft **1.21.1 – 1.21.11**.
